...
public abstract class AbstractMerchantEvent extends AbstractBusinessEvent {
     ...
     */
    public AbstractMerchantEvent(AbstractBusinessEventSource abstractBusinessEventSource) {
